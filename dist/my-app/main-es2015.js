...
*/
const routes = [{ path: '', component: _home_page_home_page_component__WEBPACK_IMPORTED_MODULE_5__["HomePageComponent"] },
...
*/
let UpdateDeleteComponent = class UpdateDeleteComponent {
    constructor(apiService) {
        this.apiService = apiService;
        this.survey = new _student_survey__WEBPACK_IMPORTED_MODULE_2__["StudentSurvey"];
        this.submitted = false;
...
UpdateDeleteComponent.ctorParameters = () => [
    { type: _api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }
];
